...
@patch('agentrouter.notify.NotificationKit.send_email')
@patch('agentrouter.notify.NotificationKit.send_dingtalk')
@patch('agentrouter.notify.NotificationKit.send_wecom')
@patch('agentrouter.notify.NotificationKit.send_pushplus')
@patch('agentrouter.notify.NotificationKit.send_feishu')
